...
namespace ILK_Protokoll.util
{
	public static class HtmlRenderExtensions
	{
		...
		public static MvcHtmlString RenderDelayed(this HtmlHelper helper, string injectionBlockId = null,
			bool removeAfterRendering = true)
		{
			Queue<string> stack = DelayedInjectionBlock.GetQueue(helper, injectionBlockId);
		...
		private class DelayedInjectionBlock : IDisposable
		{
			...
			public void Dispose()
			{
				...
				Dictionary<string, int> existingIdentifiers = _GetOrSet(helper, new Dictionary<string, int>(), UNIQUE_IDENTIFIER_KEY);
